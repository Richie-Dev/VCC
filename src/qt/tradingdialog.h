...
private slots:
    ...
    QString BuyVCC(QString OrderType, double Quantity, double Rate);
    QString SellVCC(QString OrderType, double Quantity, double Rate);
