...
{
    resize(900, 520);
    setWindowTitle(tr("VCC") + " - " + tr("Wallet"));
    //this->setStyleSheet("background-color: #ffffff;");
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/vcc-48"));
    setWindowIcon(QIcon(":icons/vcc-48"));
#else
    ...
    // Title bar styling
    setObjectName("vcc");
    setStyleSheet("#vcc { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #cecece, stop: 1 #e4e4e4);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    centralStackedWidget->setStyleSheet("background-color: #ffffff; }");
    ...
    statusBar()->setStyleSheet("#statusBar { color: #2a2a2a; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #44A1D4, stop: 1 #44A1D4);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a VCC address"));
    ...
    aboutAction = new QAction(tr("&About VCC"), this);
    aboutAction->setToolTip(tr("Show information about VCC"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for VCC"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/vcc-48"), tr("&Show / Hide"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #16244f; font-size: 15px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-weight: 100; font-variant: small-caps; padding: 3px; border: none;}"
                           "QToolButton:hover { background-color: #4fa9db; border: none; padding-top: 3px; padding-bottom: 3px; }"
                           "QToolButton:checked { background-color: #44A1D4; border: none; padding-top: 3px; padding-bottom: 3px; }"
                           "QToolButton:pressed { background-color: #44A1D4; border: none; padding-top: 3px; padding-bottom: 3px; }"
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/vcc_testnet"));
            setWindowIcon(QIcon(":icons/vcc_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/vcc_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("VCC client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("VCC client"));
    trayIcon->setIcon(QIcon(":/icons/vcc-48"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VCC network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(tr(clientModel->isImporting() ? "Importing blocks..." : "Synchronizing with VCC network..."));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid VCC address or malformed URI parameters."));
    }
