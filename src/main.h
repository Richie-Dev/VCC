...
#define START_MASTERNODE_PAYMENTS_TESTNET 1523836800 // Monday, 2018 April 16 00:00:00 UTC
#define START_MASTERNODE_PAYMENTS 1523836800         // Monday, 2018 April 16 00:00:00 UTC
...
static const int64_t STAKE_TIMESPAN_SWITCH_TIME = 1523836800;
...
inline int64_t GetMNCollateral(int nHeight) { return 10000; } // Masternode requirement
...
public:
    ...
    {
        // vcc: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // vcc: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // vcc: two types of block: proof-of-work or proof-of-stake
    ...
    // vcc: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // vcc: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
    int64_t nMoneySupply;
#endif
    unsigned int nFlags; // vcc: block index flags
    enum {
